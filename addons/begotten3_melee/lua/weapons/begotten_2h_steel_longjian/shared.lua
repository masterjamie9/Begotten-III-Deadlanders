...
SWEP.PrintName = "Steel Long Jian"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "SteelLongJianAttackTable"
SWEP.BlockTable = "SteelLongJianBlockTable"
...
SWEP.VElements = {
	["v_steellongjian"] = { type = "Model", model = "models/begotten/weapons/goose/sokkassword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.482, 0.676, -5.874), angle = Angle(175.934, -12.506, 92.263), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_steellongjian"] = { type = "Model", model = "models/begotten/weapons/goose/sokkassword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.8, 0.77, 9.31), angle = Angle(178.51, 145.79, 265.72), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}