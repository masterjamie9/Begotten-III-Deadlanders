...
SWEP.PrintName = "Celestial Soulslayer"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "CelestialSoulslayerAttackTable"
SWEP.BlockTable = "DemonSlayerAxeBlockTable"
...
SWEP.VElements = {
	["v_celestialsoulslayer"] = { type = "Model", model = "models/props/begotten/melee/celestial_soulslayer.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.1, -0.01, 0), angle = Angle(86.493, 0, -81), size = Vector(0.879, 0.879, 0.879), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_celestialsoulslayer"] = { type = "Model", model = "models/props/begotten/melee/celestial_soulslayer.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.099, 1.299, 2.596), angle = Angle(85, 0.649, -5.325), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}