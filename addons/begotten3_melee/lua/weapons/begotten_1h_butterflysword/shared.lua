...
SWEP.PrintName = "Butterfly Sword"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ButterflySwordAttackTable"
SWEP.BlockTable = "ButterflySwordBlockTable"
...
SWEP.VElements = {
	["v_butterflysword"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.399, 0.518), angle = Angle(-10.52, -171.818, -169.482), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_butterflysword"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.9, 1.299, 0.518), angle = Angle(-174.157, -24.546, -10.52), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.VElementsDual = {
	["v_left"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "Dummy16", rel = "", pos = Vector(-0, -8.396, -0.494), angle = Angle(180, -10, -96.667), size = Vector(0.949, 0.949, 0.949), material = "", skin = 0, bodygroup = {} },
	["v_right"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "Dummy01", rel = "", pos = Vector(1.48, -10.37, 1.48), angle = Angle(180, 1.11, -74.445), size = Vector(0.949, 0.949, 0.949), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsDual = {
	["w_left"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.301, 0.919, -0.648), angle = Angle(-10.521, -171.818, 0.481), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} },
	["w_right"] = { type = "Model", model = "models/props/begotten/melee/butterfly_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.399, 0.518), angle = Angle(-10.52, -171.818, 160.482), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}