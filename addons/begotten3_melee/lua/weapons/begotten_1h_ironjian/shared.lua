...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "IronJianAttackTable"
SWEP.BlockTable = "IronJianBlockTable"
...
SWEP.VElements = {
	["v_ironjian"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.788, 1.386, 0.462), angle = Angle(100.956, -1.209, 103.778), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_ironjian"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.5, -0.104), angle = Angle(80.233, -113.89, 20.049), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} },
}

SWEP.VElementsDual = {
	["v_left"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "Dummy16", rel = "", pos = Vector(0.4, -7.68, -0.283), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} },
	["v_right"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "Dummy01", rel = "", pos = Vector(0.802, -10.822, 0.444), angle = Angle(0, -90, 10), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsDual = {
	["w_left"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.595, 1.156, 0.976), angle = Angle(-70, 120, -176.495), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} },
	["w_right"] = { type = "Model", model = "models/begotten/weapons/goose/hanjian.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.595, 1.156, 0.976), angle = Angle(110, 80, -15), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), material = "", skin = 0, bodygroup = {} },
}