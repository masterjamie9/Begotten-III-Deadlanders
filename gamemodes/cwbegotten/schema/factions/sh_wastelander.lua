...
RANDOM_FORENAMES = {
	...
	["deadlander"] = {
        ["male"] = {"Alchidai", "Altun", "Amal", "Bagaridai", "Baidar", "Bayar", "Belgunutei", "Besutei", "Bogarji", "Bor", "Borte", "Bukha", "Bultechu", "Chaghagan", "Chagur", "Chambui", "Checheyigen", "Chilger", "Chormakhan", "Cota", "Cotota", "Daidukul", "Darbai", "Daritai", "Dei", "Dologadai", "Dorgene", "Ergene", "Galdan", "Ghazan", "Ghengis", "Ghoa", "Hobogetur", "Hogelun", "Hujaghur", "Idughadai", "Jajiradai", "Jarchigudai", "Kaya", "Khabichi", "Khadagh", "Khaguran", "Khal", "Khogaghchin", "Khojin", "Khongkhortai", "Khudu", "Khudus", "Kokochu", "Maqali", "Maral", "Menggetu", "Mongoljin", "Mungetu", "Myagmar", "Narengawa", "Narengawa", "Narengawa", "Nekun", "Nogai", "Okhotur", "Onggur", "Qorisubechi", "Sechen", "Shiban", "Shiramun", "Subetei", "Tagadhur","Tartu", "Tegusken", "Teleboge", "Thaube", "Toragana", "Tutei", "Ulagchi", "Wulsi", "Yesunge"},
...
RANDOM_SURNAMES = {
	...
	["deadlander"] = {
        "Altanbaatariin", "Altantsetseg", "Altantuya", "Amarsanaa", "Baatar", "Baatarkhuu", "Barsotti", "Batbayar", "Batjargal", "Bolormaa", "Borjigin", "Bugural", "Buyantu", "Dashdorj", "Davaa", "Dorjoo", "Dorjsuren", "Enebish", "Enkhbold", "Enkhjargal", "Enkhjin", "Enkhsaikhan", "Erdene", "Ganbold", "Gansukh", "Gantulga", "Ganzorig", "Gegeen", "Javkhlan", "Jigjidsuren", "Jochi", "Khulan", "Kucugur", "Lkhagvasuren", "Mongke", "Munkhbat", "Nergui", "Orgil", "Otgonbayar", "Oyuunchimeg", "Purevsuren", "Qongqor", "Ragibagh", "Ryba", "Saruul", "Sukhbaatar", "Tomorbaatar", "Tserendorj", "Tsogtgerel", "Tsolmon", "Tumenjargal", "Tumurbaatar", "Tungalag", "Tuvshin", "Tuvshinbayar", "Ulgen", "Uranchimeg", "Yesun"
	},
	["goreic"] = {
