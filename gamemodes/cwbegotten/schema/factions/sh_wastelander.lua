...
RANDOM_FORENAMES = {
	...
	["deadlander"] = {
        ["male"] = {"Tartu", "Khaguran", "Okhotur", "Khongkhortai", "Daidukul", "Ulagchi", "Bor", "Subetei", "Lefwald", "Mungetu", "Myagmar", "Bukha", "Tutei", "Khudu", "Nekun", "Chaghagan", "Jajiradai", "Khadagh", "Shiban", "Bogarji", "Mongke", "Billy", "Tatar", "Maqali", "Khal", "Monx", "Galdan", "Nogai", "Thaube", "Chaghagan", "Alchidai", "Bultechu", "Chaghagan", "Chormakhan", "Hobogetur", "Darbai", "Orville", "Amal", "Daritai", "Kokochu", "Tagadhur", "Humble", "Lonesome", "Rivers", "Scouting", "Hordeling", "Gashound", "Filler", "Crying", "Slicer", "Wisdom", "Method", "Gentle", "Scary", "Scrying", "Lethal", "Faithful", "Loser", "Expendable", "Meat", "Crafter", "Ghengis", "Bayar", "Teleboge", "Yesunge", "Dologadai", "Dei", "Besutei", "Shiramun", "Chilger", "Hogelun", "Sechen", "Narengawa", "Khogaghchin", "Cotota", "Chambui", "Borte", "Chagur", "Checheyigen", "Hujaghur", "Tegusken", "Maral", "Altun", "Ghoa", "Ergene", "Narengawa", "Cota", "Toragana", "Mongoljin", "Khojin", "Narengawa", "Akeman", "Dorgene", "Kaya", "Belgunutei", "Onggur", "Brave", "Angry", "Loathsome", "Pitiful", "Proud", "Killer", "Insane", "Corpser", "Charles", "Ghazan", "Jarchigudai", "Menggetu", "Baidar", "Khabichi", "Wulsi", "Qorisubechi", "Idughadai", "Khudus", "Bagaridai"},
        ["female"] = {"Slave", "Bitch", "Whore", "Slut", "Property", "Woman", "Witch", "She", "Whore"} --Female names shouldn't appear for this selection but just incase.
	},
	["goreic"] = {
...
RANDOM_SURNAMES = {
	...
	["deadlander"] = {
        "Crabby", "Warlike", "Stokes", "Furtive", "Cultured", "Phobic", "Slayer", "Terrible", "Vagabond", "Insect", "Nasty", "Meat", "Investor", "Grasper", "Feeder", "Supplier", "Filler", "Endorser", "Pointer", "Firefist", "Obedient", "Blower", "Fatso", "Spear", "Bowman", "Archer", "Daggers", "Gunner", "Warhero", "Manifesto", "Spicelord", "Raider", "Mantis", "Batbayar", "Bolormaa", "Altanbaatariin", "Buyantu", "Ragibagh", "Yesun", "Deadmane", "Gegeen", "Kucugur", "Qongqor", "Altantsetseg", "Tomorbaatar", "Tungalag", "Barsotti", "Cannon", "Carver", "Carman", "Cook", "Fletcher", "Gardner", "Hunter", "Láník", "Lovász", "Offermans", "Patel", "Ryder", "Ryba", "Schröter", "Schüttmann", "Sexton", "Steed", "Steele", "Rust", "Scrap", "Diamond", "Thrall", "Suitor", "Eddie", "Chaser", "Necromancer", "Grunt", "Ironclad", "Giant", "Weaver", "Yates", "Tucker"
	},
	["goreic"] = {
...
local FACTION = Clockwork.faction:New("Deadlander");
	local deadlanderModels = {
		male = {
			clothes = "models/begotten/prelude_deadlanders/deadlanderspawn_male.mdl",
			heads = {
				"male_01",
				"male_02",
				"male_03",
	...
	FACTION.availablefaiths = {"Faith of the Winds"};
	FACTION.singleGender = GENDER_MALE;
	FACTION.characterLimit = 1; -- # of characters of this faction a player can have.
	FACTION.names = "deadlander";
	FACTION.imposters = false;
	FACTION.subfactions = {
		{
			name = "Raiders",
			subtitle = "Warriors - Blood of the Horde",
			description = "The Deadlander Raiders consist of veteran soldiers who have long served their Khan. To become part of the horde usually requires one to be born into the Deadlanders, though from time to time unaligned tribes have been captured and merged as part of the Horde. These brutalists survive through constant travel and pillaging of their lessers. Merciless as they may be, a great bond is shared between their members. Only through loyalty and service to the Khan, can they survive.",
			attributes = {
				{Color(0, 225, 0), "(+) Perfect Balance: Starts with +15 maximum stability."},
				{Color(0, 225, 0), "(+) Born Raiders: Starts with +15 maximum health."},
				{Color(0, 225, 0), "(+) Horde Tactics: +100% faith gain from dealing damage."},
				{Color(0, 225, 0), "(+) Starts at Sacrament Level 6"},
				{Color(0, 225, 0), "(+) Has +3kg extra weight capacity"},
			},
			
		models = deadlanderModels},
		{
			name = "Tuners",
			subtitle = "Servants - Crafters and Mechanics",
			description = "Through the glory and blood of the Khan and his soldiers, a lesser force greases the axels of their bikes, and polishes the leather seats of their jeeps. The Tuners are the logistical backbone of the Deadlander Horde. They are knowledgeable servants that compile the lost information of the Old World, and use it to enhance the power of their crafts. Though all Deadlanders are trained to fight at birth, it is through crafting that the Tuners truly shine.",
			attributes = {
				{Color(0, 225, 0), "(+) Manufacturer's Notes: +33% increased faith gain"},
				{Color(0, 225, 0), "(+) Starts at Sacrament Level 12"},
				{Color(0, 225, 0), "(+) Has +6kg extra weight capacity"},
			},
		models = deadlanderModels},
	}
	-- Called when a player is transferred to the faction.
	...
	Schema.RankTiers["Deadlander"] = {
		[1] = {"Raider", "Tuner"},
		[2] = {"Road Warrior", "Engine Hummer"},
		[3] = {"Wheelman"}, 
		[4] = {"Dread Khan"},
	};
	
	Schema.RanksToBuffs["Deadlander"] = {
		["Road Warrior"] = {health = 15, stamina = 10},
		["Engine Hummer"] = {health = 10, stamina = 5},
		["Wheelman"] = {health = 20, stamina = 15},
		["Dread Khan"] = {health = 45, stamina = 35},
	};
	
	Schema.RanksToSubfaction["Deadlander"] = {
		["Tuner"] = "Tuners",
